...
![SignIn Page](</frontend/Screenshot (286).png>)
![LogIn Page](</frontend/Screenshot (287).png>)
![Home Problems Page](</frontend/Screenshot (288).png>)
![Code Solve Editor page](</frontend/Screenshot (289).png>)
![Refer. Solution](</frontend/Screenshot (290).png>)
![Submission History](</frontend/Screenshot (291).png>)
![AdminPaned](</frontend/Screenshot (292).png>)
![Create a new Problem](</frontend/Screenshot (293).png>)
![Delete a problem](</frontend/Screenshot (294).png>)
![Add Solution Video](</frontend/Screenshot (295).png>)
